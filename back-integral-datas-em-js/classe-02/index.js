const registros = [
  ...
  const verificadorDeRegistros = registros.sort((registroA, registroB) => {
    const dataA = new Date(registroA.registered);
    const dataB = new Date(registroB.registered);
  
    return dataA - dataB;
    
  });
  
  console.log(verificadorDeRegistros);
